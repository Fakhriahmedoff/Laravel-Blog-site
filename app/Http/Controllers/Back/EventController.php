...
class EventController extends Controller
{
    ...
    public function index()
    {
        ...
        $articles=Singleevent::orderby('id' ,'ASC')->get();
        return view('back.events.index',compact('articles'));
    }
    ...
    {   
        $article=Singleevent::findOrFail($id);
                                                                        


        $categories=Event::all();
        return view('back.events.edit', compact('article','categories'));
    }
